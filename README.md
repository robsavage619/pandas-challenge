...
The purpose of this exercise was to take a mid-size data set that included metrics for the microtransactions within Heroes of Pymoli and analyze them using different lines of code. 

The code written for this exercise helped analyze the following metrics:
